 ...
 * @author Nikx
 */
public class ubah_gk extends javax.swing.JFrame {
    ...
    public void golongan6(){
        try{
          String tunjangan="SELECT * FROM `lembur` WHERE id_lembur ='"+il.getSelectedItem().toString()+"'";
    ...
    private void rSButtonRiple1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonRiple1ActionPerformed
        String sql = "update gaji set kd_jabatan=?,gol=?,id_lembur=?,total_potongan=?,total_gaji=? where nip=?";
        try {
            PreparedStatement stat = conn.prepareStatement(sql);
            stat.setString(1, kj.getText());
            stat.setString(2, gl.getText());
            stat.setString(3, ula.getText());
            stat.setString(4, tp.getText());
            stat.setString(5, total_gaji.getText());
            stat.setString(6, nip.getSelectedItem().toString());
            stat.executeUpdate();
...
//    total_gaji.setText(String.valueOf(second));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ubah_gk.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public javax.swing.JComboBox<String> il;
    ...
    public javax.swing.JComboBox<String> nip;
    ...
    public javax.swing.JTextField total_gaji;
