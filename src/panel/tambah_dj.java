 ...
 * @author Nikx
 */
public class tambah_dj extends javax.swing.JFrame {
    ...
    private void rSButtonRiple1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonRiple1ActionPerformed
        ...
        try {
            ...
            stat.setString(1, kd_jabatan.getText());
            stat.setString(2, nm_jabatan.getText());
            stat.setString(3, gp.getText());
            stat.setString(4, golongan.getSelectedItem().toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tambah_dj.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextField kd_jabatan;
    private javax.swing.JTextField nm_jabatan;
