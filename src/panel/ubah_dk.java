 ...
 * @author Nikx
 */
public class ubah_dk extends javax.swing.JFrame {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(tm, javax.swing.GroupLayout.PREFERRED_SIZE, 127, javax.swing.GroupLayout.PREFERRED_SIZE))
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                        .addGap(23, 23, 23)
                                        .addComponent(tm, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)))))
    ...
    private void rSButtonRiple1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonRiple1ActionPerformed
        String sql = "update dk set nama=?,tempat_lahir=?,tanggal_lahir=?,jenis_kelamin=?,agama=?,pernikahan=?,anak=?,alamat=?,telp=?,pendidikan=?,gol=?,kd_jabatan=?,tgl_diangkat=? where nip=?";
        try {
            PreparedStatement stat = conn.prepareStatement(sql);
            stat.setString(1, nk.getText());
            stat.setString(2, tl.getSelectedItem().toString());
            
            java.util.Date utilStartDate = tl2.getDate();
        java.sql.Date sqlStartDate = new java.sql.Date(utilStartDate.getTime());
            stat.setDate(3, sqlStartDate);
//            stat.setString(4, ((JTextField)tl2.getDateEditor().getUiComponent()).getText());
            String jk="";
            if(l.isSelected()) jk="Laki-laki";
            else jk="Perempuan";
            stat.setString(4, jk);
            stat.setString(5, agm.getSelectedItem().toString());
            
            String sp="";
            if(sm.isSelected()) sp="Sudah Menikah";
            else sp="Belum Menikah";
            stat.setString(6, sp);
            stat.setString(7, ja.getText());
            stat.setString(8, alm.getText());
            stat.setString(9, telp.getText());
            stat.setString(10, pend.getSelectedItem().toString());
        ...
        java.sql.Date sqlStartDate2 = new java.sql.Date(utilStartDate2.getTime());
            stat.setDate(13, sqlStartDate2);
            stat.setString(14, nip.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ubah_dk.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public javax.swing.JComboBox<String> agm;
    public javax.swing.JTextArea alm;
    public javax.swing.JRadioButton bm;
    ...
    public javax.swing.JTextField ja;
    public javax.swing.JRadioButton l;
    public javax.swing.JTextField nip;
    public javax.swing.JTextField nk;
    public javax.swing.JRadioButton p;
    public javax.swing.JComboBox<String> pend;
    private rojeru_san.RSButtonRiple rSButtonRiple1;
    private rojeru_san.RSButtonRiple rSButtonRiple2;
    public javax.swing.JRadioButton sm;
    public javax.swing.JTextField telp;
    public javax.swing.JComboBox<String> tl;
    public com.toedter.calendar.JDateChooser tl2;
    public com.toedter.calendar.JDateChooser tm;
